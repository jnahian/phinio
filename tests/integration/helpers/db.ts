...
export async function resetDb() {
  ...
  await prisma.$executeRawUnsafe(
    `TRUNCATE TABLE "processed_mutations", "activity_log", "push_subscriptions", "notifications", "emi_payments", "emis", "investment_withdrawals", "investment_deposits", "investments", "profiles", "verification", "account", "session", "user" RESTART IDENTITY CASCADE`,
  )
}
