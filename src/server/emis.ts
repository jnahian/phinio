...
export const listEmisFn = createServerFn({ method: 'GET' })
  ...
  .handler(async ({ data }) => {
    ...
    return listEmisImpl(profileId, data)
  })
...
export const getEmiFn = createServerFn({ method: 'GET' })
  ...
  .handler(async ({ data }) => {
    const profileId = await requireProfileId()
    return getEmiImpl(profileId, data.emiId)
  })
...
export const createEmiFn = createServerFn({ method: 'POST' })
  ...
  .handler(async ({ data }) => {
    const profileId = await requireProfileId()
    return createEmiImpl(profileId, data)
  })
...
export const deleteEmiFn = createServerFn({ method: 'POST' })
  ...
  .handler(async ({ data }) => {
    const profileId = await requireProfileId()
    return deleteEmiImpl(profileId, data.emiId)
  })
...
export const markPaymentPaidFn = createServerFn({ method: 'POST' })
  ...
  .handler(async ({ data }) => {
    const profileId = await requireProfileId()
    return markPaymentPaidImpl(profileId, data)
  })
