...
export function TopBar({ title, backTo, userName, avatarUrl }: TopBarProps) {
  ...
  return (
    <header className="sticky top-0 z-30 flex items-center justify-between gap-3 bg-surface px-5 pb-3 pt-[calc(0.75rem+env(safe-area-inset-top))]">
      ...
      <div className="flex shrink-0 items-center gap-2">
        ...
        <Link
          ...
          aria-label={t('ariaLabels.profile')}
        >
          <img
            src={avatarUrl}
            alt={userName}
