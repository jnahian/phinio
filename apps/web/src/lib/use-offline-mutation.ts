 ...
 * `clientMutationId` automatically; callers don't need to provide it. Server
 * functions accept it as optional, so omitting it on a stale call site is
 * safe — but the queue's idempotency safety relies on it being present.
 */
